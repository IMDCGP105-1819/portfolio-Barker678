...
def game():
    ...
    def chapter_1():
        ...
        ch1 = str(input('would you like to run? [y/n]: '))                                  # NOTE: this will change throughout the game; chapter 2 has more things to do as i feel like chapter 1 opens the story of where the player is and
        if ch1 in ['y', 'Y', 'Yes', 'YES', 'yes']:                                          # NOTE: what they should be doing, i will make some changes so that the player has more choices in chapter 1
